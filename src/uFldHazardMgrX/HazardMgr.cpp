  ...
  for(p=NewMail.begin(); p!=NewMail.end(); p++) {
    ...
    {  
      ...
      {    
        ...
        string ss_str="\"" + ss + "\"";
        Notify("TEST1", ss);
        m_label_buf_dequ.push_back(ss);

        Notify("DEQ", m_label_buf_dequ.back()); 
        ...
        string node_format="src_node=kasper,dest_node=all,var_name=UHZ_DETECTION_REPORT,string_val=\"" + m_label_buf_dequ.back() + "\"";
        Notify("NODE_MESSAGE_LOCAL", node_format );

        //string node_format_two="src_node=jake,dest_node=kasper,var_name=UHZ_DETECTION_REPORT,string_val=\"" + m_label_buf_dequ.back() + "\"";
        //Notify("NODE_MESSAGE_LOCAL", node_format_two);
      }
...
//    break;
//  else{
//    string test="src_node=kasper,dest_node=all,var_name=UHZ_DETECTION_REPORT,string_val="+m_label_buf_dequ.front();
//    Notify("NODE_MESSAGE_LOCAL",test);
